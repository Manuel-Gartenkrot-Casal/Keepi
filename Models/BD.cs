...
public class BD
{
    ...
    public static int agregarHeladera(string nombre, string color, int idUsuario)
    {
        int resultado = -1;
        ...
        using (SqlConnection connection = new SqlConnection(_connectionString))
        {
            ...
            resultado = connection.QueryFirstOrDefault<int>(
                StoredProcedure,
                new { Nombre = nombre, Color = color, IdUsuario = idUsuario },
                commandType: CommandType.StoredProcedure
            );
    ...
    public static int borrarHeladera(int idHeladera, int idUsuario)
    {
        int resultado = -1;
        using (SqlConnection connection = new SqlConnection(_connectionString))
        {
            ...
            resultado = connection.QueryFirstOrDefault<int>(
                StoredProcedure,
                new { IdHeladera = idHeladera, IdUsuario = idUsuario },
                commandType: CommandType.StoredProcedure
            );
    ...
    public static void ActualizarTipoAlmacenamientoProducto(int idProductoXHeladera, string tipoAlmacenamiento)
    {
        string sql = "UPDATE ProductoXHeladera SET TipoAlmacenamiento = @TipoAlmacenamiento WHERE Id = @Id";
        using (SqlConnection connection = new SqlConnection(_connectionString))
        {
            connection.Execute(sql, new { Id = idProductoXHeladera, TipoAlmacenamiento = tipoAlmacenamiento });
        }
    }
    ...
    {
        Producto producto = null;
        string storedProcedure = "sp_GetProductoById";
        using (SqlConnection connection = new SqlConnection(_connectionString))
        {
            producto = connection.QueryFirstOrDefault<Producto>(
                storedProcedure,
